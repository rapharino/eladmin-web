<template>
  <div>
    ...
    <el-dialog :visible.sync="dialog" :close-on-click-modal="false" :before-close="cancel" title="代码生成配置" append-to-body width="1000px">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      beforeInit() {
        // this.url = 'api/metadata/datasource/'+this.$route.query.datasource+"/"+this.name
        // this.url = 'api/metadata/datasource/'+
